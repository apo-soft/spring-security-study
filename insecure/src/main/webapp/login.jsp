...
<body onload="document.f.j_username.focus();">
	...
	<p>
	<p>
		username <b>rod</b>, password <b>koala</b>
	<p>
		username <b>dianne</b>, password <b>emu</b>
	<p>
		username <b>scott</b>, password <b>wombat</b>
	<p>
		username <b>peter</b>, password <b>opal</b> (user disabled)
	<p>
		username <b>bill</b>, password <b>wombat</b>
	<p>
		username <b>bob</b>, password <b>wombat</b>
	<p>
		username <b>jane</b>, password <b>wombat</b>
	<p>
	<p>
		Locale is:
		<%=request.getLocale()%></p>
